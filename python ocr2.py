...
with open("D:\Downloads\Python_OCR\input\path2.txt", 'r', encoding='utf-8') as f:
...
im.save("D:\Downloads\Python_OCR\output2\page_02.png")
...
cv2.imwrite("D:\Downloads\Python_OCR\output2\inverted2.png", inverted_image)
...
cv2.imwrite("D:\Downloads\Python_OCR\output2\gray2.png", gray_image)
...
cv2.imwrite("D:\\Downloads\\Python_OCR\\output2\\black_image2.png", bwimage)
...
cv2.imwrite("D:\\Downloads\\Python_OCR\\output2\\no_noise2.png", no_noise)
...
cv2.imwrite("D:\\Downloads\\Python_OCR\\output2\\eroded_image2.png", eroded_image)
...
cv2.imwrite("D:\\Downloads\\Python_OCR\output2\\dilated_image2.png", dilated_image)
...
def getSkewAngle(cvImage) -> float:
    ...
    cv2.imwrite("D:\\Downloads\\Python_OCR\\output2\\boxes2.png", newImage)
    angle = minAreaRect[-1]
    if angle < -45:
        angle = 90 + angle
    return -1.0 * angle
...
fixed = deskew(new)
cv2.imwrite("D:\\Downloads\\Python_OCR\\output2\\rotated_fixed2.png", fixed)
...
cv2.imwrite("D:\\Downloads\\Python_OCR\\output2\\image_with_border2.png", image_with_border)
...
img_file = im_file
no_noise = "D:\\Downloads\\Python_OCR\\output2\\no_noise2.png"
...
output_file = open('D:\\Downloads\\Python_OCR\\output2.txt', 'w')
...
if compare_text_process.returncode != 0:
    raise Exception('Error running compare text.py script')

## delete after output
output_folder_path = os.path.join('D:', 'Downloads', 'Python_OCR', 'output2')
